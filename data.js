      ...
      <div class="card-content">
        <div class="card-header">
          ...
          <div class="card-header-actions">
            <button>
              <img src="./assests/edit-icon.svg" alt="edit-button" />
            </button>
            <button>
              <img src="./assests/trash-icon.svg" alt="delete-button" />
            </button>
          </div>
        </div>
        <p>
          Climbing up the Eiffel Tower is a must-do for me. Whether by elevator
          or stairs, reaching the top for panoramic views of Paris is going to
          be unforgettable.
        </p>
